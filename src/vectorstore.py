    ...
    if os.path.exists(directorio_persistencia) and os.listdir(directorio_persistencia):
        ...
        vectorstore = Chroma(
            ...
            vectorstore = Chroma.from_documents(
                ...
                embedding=modelo_embeddings,    # Se conecta a la API de Google usando el modelo de embeddings (modelo_embeddings).
                persist_directory=directorio_persistencia # Guarda la base de datos vectorial en el directorio especificado para futuras cargas rápidas.
            )
